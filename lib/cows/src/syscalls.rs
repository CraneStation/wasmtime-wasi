...
fn return_encoded_errno(e: host::cloudabi_errno_t) -> wasm32::cloudabi_errno_t {
...
pub unsafe extern "C" fn condvar_signal(
    ...
    unimplemented!("cloudabi_sys_condvar_signal");
}
...
pub unsafe extern "C" fn file_advise(
    fd: wasm32::cloudabi_fd_t,
    offset: wasm32::cloudabi_filesize_t,
    len: wasm32::cloudabi_filesize_t,
    advice: wasm32::cloudabi_advice_t,
    vmctx: *mut VMContext,
) -> wasm32::cloudabi_errno_t {
    trace!(
...
pub unsafe extern "C" fn lock_unlock(
    ...
    unimplemented!("cloudabi_sys_lock_unlock");
}
...
pub unsafe extern "C" fn mem_advise(
    ...
    unimplemented!("cloudabi_sys_mem_advise");
}
...
pub unsafe extern "C" fn mem_map(
    ...
    unimplemented!("cloudabi_sys_mem_map");
}
...
pub unsafe extern "C" fn mem_protect(
    ...
    unimplemented!("cloudabi_sys_mem_protect");
}
...
pub unsafe extern "C" fn mem_sync(
    ...
    unimplemented!("cloudabi_sys_mem_sync");
}
...
pub unsafe extern "C" fn mem_unmap(
    ...
    unimplemented!("cloudabi_sys_mem_unmap");
}
...
pub unsafe extern "C" fn proc_exec(
    ...
    unimplemented!("cloudabi_sys_proc_exec");
}
...
pub unsafe extern "C" fn proc_exit(rval: u32, _vmctx: *mut VMContext) -> ! {
    ...
    // TODO: Rather than call cloudabi_sys_proc_exit here, we should trigger a
    // stack unwind similar to a trap.

    panic!("cloudabi_sys_proc_exit({})", rval)
}
...
pub unsafe extern "C" fn proc_raise(
    _sig: wasm32::cloudabi_signal_t,
    _vmctx: *mut VMContext,
) -> wasm32::cloudabi_errno_t {
    unimplemented!("cloudabi_sys_proc_raise");
}
...
pub unsafe extern "C" fn thread_exit(
    ...
    unimplemented!("cloudabi_sys_thread_exit");
}

pub unsafe extern "C" fn thread_yield(_vmctx: *mut VMContext) -> wasm32::cloudabi_errno_t {
    unimplemented!("cloudabi_sys_thread_yield");
}
