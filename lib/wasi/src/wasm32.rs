...
pub const __WASI_FILE_FILESTAT_SET_ATIM: __wasi_fstflags_t = 1;
pub const __WASI_FILE_FILESTAT_SET_ATIM_NOW: __wasi_fstflags_t = 2;
pub const __WASI_FILE_FILESTAT_SET_MTIM: __wasi_fstflags_t = 4;
pub const __WASI_FILE_FILESTAT_SET_MTIM_NOW: __wasi_fstflags_t = 8;
...
pub const __WASI_RIGHT_FILE_FILESTAT_GET: __wasi_rights_t = 262144;
pub const __WASI_RIGHT_FILE_FILESTAT_SET_SIZE: __wasi_rights_t = 524288;
pub const __WASI_RIGHT_FILE_FILESTAT_SET_TIMES: __wasi_rights_t = 1048576;
