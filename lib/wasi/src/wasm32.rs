...
pub const __WASI_FILETYPE_PROCESS: __wasi_filetype_t = 4;
pub const __WASI_FILETYPE_REGULAR_FILE: __wasi_filetype_t = 5;
pub const __WASI_FILETYPE_SHARED_MEMORY: __wasi_filetype_t = 6;
pub const __WASI_FILETYPE_SOCKET_DGRAM: __wasi_filetype_t = 7;
pub const __WASI_FILETYPE_SOCKET_STREAM: __wasi_filetype_t = 8;
pub const __WASI_FILETYPE_SYMBOLIC_LINK: __wasi_filetype_t = 9;
...
pub const __WASI_MAP_PRIVATE: __wasi_mflags_t = 4;
pub const __WASI_MAP_SHARED: __wasi_mflags_t = 8;
pub const __WASI_PROT_READ: __wasi_mprot_t = 1;
pub const __WASI_PROT_WRITE: __wasi_mprot_t = 2;
pub const __WASI_PROT_EXEC: __wasi_mprot_t = 4;
pub const __WASI_MS_ASYNC: __wasi_msflags_t = 1;
pub const __WASI_MS_INVALIDATE: __wasi_msflags_t = 2;
pub const __WASI_MS_SYNC: __wasi_msflags_t = 4;
