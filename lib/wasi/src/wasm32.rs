...
pub const __WASI_PATH_FILESTAT_SET_ATIM: __wasi_fstflags_t = 1;
pub const __WASI_PATH_FILESTAT_SET_ATIM_NOW: __wasi_fstflags_t = 2;
pub const __WASI_PATH_FILESTAT_SET_MTIM: __wasi_fstflags_t = 4;
pub const __WASI_PATH_FILESTAT_SET_MTIM_NOW: __wasi_fstflags_t = 8;
...
pub const __WASI_RIGHT_PATH_UNLINK_DIRECTORY: __wasi_rights_t = 33554432;
