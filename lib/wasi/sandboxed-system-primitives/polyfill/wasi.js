...
fd_dup: function(from, fd) {
    return ___wasi_fd_dup(from, fd);
},
...
fd_replace: function(from, to) {
    return ___wasi_fd_replace(from, to);
},
...
file_create: function(fd, path, path_len, type) {
    let host_path = _malloc(path_len);
    memcpy_to_host_from_guest(host_path, path, path_len);
    var ret = ___wasi_file_create(fd, host_path, path_len, type);
    _free(host_path);
    return ret;
},
...
file_open: function(dirfd, path, path_len, oflags, fds, fd) {
    console.log("unimplemented WASI syscall: file_open");
    return 52; // ENOSYS
},
...
file_stat_fget: function(fd, buf) {
    console.log("unimplemented WASI syscall: file_stat_fget");
    return 52; // ENOSYS
},

file_stat_fput: function(fd, buf, flags) {
    console.log("unimplemented WASI syscall: file_stat_fput");
    return 52; // ENOSYS
},
...
file_stat_put: function(fd, path, path_len, buf, flags) {
    console.log("unimplemented WASI syscall: file_stat_put");
    return 52; // ENOSYS
},
...
poll: function(in_, out, nsubscriptions, nevents) {
    console.log("unimplemented WASI syscall: poll");
    return 52; // ENOSYS
},
...
sock_recv: function(sock, in_, out) {
    console.log("unimplemented WASI syscall: sock_recv");
    return 52; // ENOSYS
},

sock_send: function(sock, in_, out) {
