...
file_create_directory: function(fd, path, path_len) {
    ...
    var ret = ___wasi_file_create_directory(fd, host_path, path_len);
    _free(host_path);
    return ret;
},
...
file_unlink_file: function(fd, path, path_len, flags) {
    console.log("unimplemented WASI syscall: file_unlink_file");
    return 52; // ENOSYS
},

file_unlink_directory: function(fd, path, path_len, flags) {
    console.log("unimplemented WASI syscall: file_unlink_directory");
    return 52; // ENOSYS
},
